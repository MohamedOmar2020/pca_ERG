...
tile_dir = r'/athena/marchionnilab/scratch/lab_data/Mohamed/pca_outcome/data/tiles_karen/5x/'
...
# Save to disk
MetaData_training.to_csv('objs/karen/MetaData_training_pten_5x.csv')
