...
clinical['label'] = clinical['SPOP_mut']
...
SPOP = pd.DataFrame({'label':clinical['label'], 'PatientID':clinical['PATIENT_ID']})
...
MetaData_training = pd.merge(MetaData_training, SPOP, left_on = 'PatientID', right_on='PatientID')
...
# Save to disk
MetaData_training.to_csv('objs/karen/MetaData_training_SPOP.csv')
