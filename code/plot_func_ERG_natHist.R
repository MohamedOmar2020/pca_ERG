filter_paths_natHist <- function(status, bm_name){


   
  bm_json_path <- sprintf("hovernet_topPatches/output/%s/natHist/fusion/json", bm_name)
  wt_json_path <- sprintf("hovernet_topPatches/output/%s/natHist/wt/json", bm_name)
...
gen_plot_df_ERG_natHist <- function(bm_name){
  
  fusion_paths <- filter_paths_natHist(status = T, bm_name = bm_name)
  wt_paths <- filter_paths_natHist(status = F, bm_name = bm_name)
  
  # print(neg_paths)
  
  wt_df <- gen_count_df_ERG_natHist(json_file_paths_filt = wt_paths, status = F,bm_name = bm_name)
  bm_df <- gen_count_df_ERG_natHist(json_file_paths_filt = fusion_paths, status = T,bm_name = bm_name)
...
gen_plot_ERG_natHist <- function(df){
