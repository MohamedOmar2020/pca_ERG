...
metadata['label'] = metadata['AR_V7_presence']
...
ARv7 = pd.DataFrame({'label':metadata['label'], 'case_id':metadata['PATIENT_ID']})
...
## Add labels
MetaData_clam = pd.merge(MetaData_clam, ARv7, left_on='case_id', right_on='case_id')
...
# Save to disk
MetaData_clam.to_csv('dataset_csv/pca_ARv7.csv')
