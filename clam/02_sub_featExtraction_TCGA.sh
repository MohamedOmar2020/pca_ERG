...
CUDA_VISIBLE_DEVICES=0,1 python clam/extract_features_fp.py --data_h5_dir data/tiles_clam_1024_TCGA_lvl0 --data_slide_dir data/TCGA_FFPE --csv_path data/tiles_clam_1024_TCGA_lvl0/process_list_autogen_featExt.csv --feat_dir data/features_clam_TCGA_size1024_mag20x --batch_size 512 --slide_ext .svs --custom_downsample 2
