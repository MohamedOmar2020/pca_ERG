...
CUDA_VISIBLE_DEVICES=0,1 python clam/main.py --drop_out --early_stopping --lr 1e-4 --k 10 --label_frac 1.00 --exp_code pca_pten_256_NatHist --weighted_sample --bag_loss ce --inst_loss svm --task pca_pten_NatHist --model_type clam_sb --model_size big --log_data --data_root_dir data/features_clam_256_NatHist --results_dir objs/clam/training_results/NatHist --max_epochs 200 --split_dir pca_pten_NatHist_100
