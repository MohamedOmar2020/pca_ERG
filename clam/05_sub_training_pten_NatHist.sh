...
CUDA_VISIBLE_DEVICES=0,1 python clam/main.py --drop_out --early_stopping --lr 1e-4 --k 10 --label_frac 0.7 --exp_code pca_pten_512_NatHist_mbSmall_B250_lvl0new --weighted_sample --bag_loss ce --inst_loss ce --task pca_pten_NatHist --bag_weight 0.85 --model_type clam_mb --model_size small --B 250 --log_data --data_root_dir data/features_clam_512_NatHist_lvl0_new --results_dir objs/clam/training_results/NatHist --max_epochs 100 --split_dir pca_pten_NatHist_100
