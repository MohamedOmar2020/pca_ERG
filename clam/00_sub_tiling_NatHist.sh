...
python clam/create_patches_fp.py --source data/NatHistory --save_dir data/tiles_clam_2048_NatHist_lvl0 --patch_size 2048 --step_size 2048 --patch_level 0 --seg --patch --stitch --preset pca_NatHist.csv 
