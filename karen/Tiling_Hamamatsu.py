from Preprocess import Tilingndpi
import argparse
import pandas as pd
import os
import re
...
def tiling(svspath,patientid,targetpath,tilesize=256,stride=256,tissuepct_value=0.7,magnification='multi'):
    ...
    if '2.5x' in mag:
        ...
        Tilingndpi.tiling_qualified_separate_2_5x(svspath=svspath,targetpath=patch_path2_5x,tilesize=tilesize,stride=stride, tissuepct_value=tissuepct_value)
    ...
    if '5x' in mag:
        ...
        Tilingndpi.tiling_qualified_separate_5x(svspath=svspath,targetpath=patch_path5x,tilesize=tilesize,stride=stride, tissuepct_value=tissuepct_value)
    ...
    if '10x' in mag:
        ...
        Tilingndpi.tiling_qualified_separate_10x(svspath=svspath,targetpath=patch_path10x,tilesize=tilesize,stride=stride, tissuepct_value=tissuepct_value)
    ...
    if '20x' in mag:
        ...
        Tilingndpi.tiling_qualified_separate_20x(svspath=svspath,targetpath=patch_path20x,tilesize=tilesize,stride=stride, tissuepct_value=tissuepct_value)
