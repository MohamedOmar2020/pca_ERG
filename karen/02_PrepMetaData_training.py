...
clinical['label'] = clinical['ERG_status']
...
ERG = pd.DataFrame({'label':clinical['label'], 'PatientID':clinical['PATIENT_ID']})

print(ERG['label'].value_counts())
...
# Save to disk
MetaData_training.to_csv('objs/karen/MetaData_training.csv')
