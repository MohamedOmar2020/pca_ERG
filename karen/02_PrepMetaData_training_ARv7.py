...
clinical['label'] = clinical['AR_V7_presence']
...
ARv7 = pd.DataFrame({'label':clinical['label'], 'PatientID':clinical['PATIENT_ID']})
...
MetaData_training = pd.merge(MetaData_training, ARv7, left_on = 'PatientID', right_on='PatientID')
